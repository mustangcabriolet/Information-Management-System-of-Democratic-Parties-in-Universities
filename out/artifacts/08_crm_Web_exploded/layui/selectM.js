		...
		$E.on('click','dd',function(e){
			...
			//选中
				...
				if(o.selected.length >= c.max){
					...
					layer.tips('------------------ 请选择 ------------------', c.elem+' .multiple', {
						tips: 3,
						time: 1000,
						end:function(){					
